...
```
wget -O zelnodeupdate.sh https://raw.githubusercontent.com/Goose-Tech/ZelNodeUpgrade/master/zelnodeupdate.sh && chmod +x zelnodeupdate.sh && bash ./zelnodeupdate.sh
```
